...
struct SessionList: View {
    ...
    init(sort: SortDescriptor<Session> = SortDescriptor(\Session.date, order: .reverse), searchString: String) {
    ...
    private func addItem() {
        ...
        let config = SessionConfig(provider: provider, model: provider.chatModel)
...
#Preview {
    SessionList(sort: SortDescriptor(\Session.date, order: .reverse), searchString: "")
        .frame(width: 400)
