    ...
    var completionToolParam: ChatQuery.ChatCompletionToolParam {
        ...
        case .urlScrape:
            return .init(function:
                    .init(name: "urlScrape",
                          description: "If a URL is explicitly given, this function can be used to receive the contents of that url webpage. If you feel absolutely confident that you know some url where some information can be found, you may come up with the url yourself and call the function with that URL. If you already know the information, do not use the function to come up with a url. Always prioritize your pre-existing knowledge. Note that this function CANNOT search the web on its own. It can only look up a sepcific url. If you find a previous google search in the chat history, you may find some urls in the search results. You may use one and only one of those urls to call this function to retrieve required. Be sure to choose the most appropriate url to call in that case on your own. The function will  visit that url and return the webcontent from it.",
                          parameters:
                            .init(type: .object,
                                  properties: ["url":
                                        .init(type: .string,
